...
from ..mod_check import MySQL, FTP, SSH, IMAP, SMTP, HTTP, LDAP
...
def ldap_check(service, username, password, domain):
    return LDAP.check.delay(host=service.host,
                            port=service.port,
                            username=username, 
                            password=password,
                            domain=domain)
...
service_list = {
    ...
    'LDAP': (ldap_check, ('username', 'password', 'domain'))
}
